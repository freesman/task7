...
(function() {
  define('models/Person',['underscore', 'backbone'], function(_, Backbone) {
    var Person;
...
define("inputmask", function(){});

(function() {
  define('views/appView',['jquery', 'underscore', 'backbone', 'epoxy', 'models/Person', 'inputmask'], function($, _, Backbone, Epoxy, Person) {
    var PersonView;
    PersonView = Backbone.Epoxy.View.extend({
      ...
      render: function() {
        ...
        return this.$('.date').inputmask('myDate');
      },
      events: {
      ...
      validator: function(attr, valLength, char) {
        var replacer, testMas, value;
      ...
      clearing: function() {
        ...
        this.helpClear(this.$('.name'));
        this.helpClear(this.$('.lastName'));
        this.helpClear(this.$('.phone'));
        this.helpClear(this.$('.mail'));
        return this.helpClear(this.$('.date'));
      },
      helpClear: function(e) {
        e.val('');
        return e.css('border-color', '#A9A9A9');
      },
      localSave: function() {
        return localStorage.setItem('person', JSON.stringify(this.model.toJSON()));
      },
      aliases: function() {
        Inputmask.extendAliases({
          'name': {
            ...
            onincomplete: function(e) {
              return $(e.currentTarget).css('border-color', '#A9A9A9');
            },
            oncomplete: function(e) {
              return $(e.currentTarget).css('border-color', 'green');
            }
          }
        });
        Inputmask.extendAliases({
          'myPhone': {
            ...
            onincomplete: function(e) {
              if ($(e.currentTarget).val()) {
                return $(e.currentTarget).css('border-color', 'red');
              } else {
                return $(e.currentTarget).css('border-color', '#A9A9A9');
              }
            },
      ...
      alert: function(switcher) {
        ...
        if (switcher === 'success') {
          return $('#alertSuccess').fadeIn(650).delay(1300).fadeOut(650);
        }
      },
      closeAlert: function() {
        return $('#alertWarn').fadeOut(0);
      }
    });
    return PersonView;
  });
